...
polyPlot <- function(training, test, pol, color, return_err) {
  ...
  text(700, 3.75, paste('Error = ', round(error,2)), cex=1.5)
  text(675, 2.5, paste('Polynomial =', pol), cex=1.5)
...
polyPlot(training, test, 20, 'black', FALSE)
...
out <- data.frame(Train_Options=c("BoxCox", "YeoJohnson", "expoTrans", "center", "scale", "range", "knnImpute", "bagImpute", "medianImpute", "pca", "ica", "spatialSign"))
